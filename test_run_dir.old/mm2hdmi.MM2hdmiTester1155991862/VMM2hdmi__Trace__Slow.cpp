...
void VMM2hdmi::traceInitThis__1(VMM2hdmi__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	// Tracing: MM2hdmi _GEN_1 // Ignored: Inlined leading underscore at MM2hdmi.v:45
	vcdp->declBus(c+5,"MM2hdmi regData",-1,15,0);
	// Tracing: MM2hdmi _T_11 // Ignored: Inlined leading underscore at MM2hdmi.v:47
	vcdp->declBus(c+6,"MM2hdmi regMuxRed0",-1,7,0);
	// Tracing: MM2hdmi _T_14 // Ignored: Inlined leading underscore at MM2hdmi.v:49
	vcdp->declBus(c+7,"MM2hdmi regMuxRed1",-1,7,0);
	// Tracing: MM2hdmi _T_17 // Ignored: Inlined leading underscore at MM2hdmi.v:51
	vcdp->declBus(c+8,"MM2hdmi regMuxRed2",-1,7,0);
	// Tracing: MM2hdmi _T_20 // Ignored: Inlined leading underscore at MM2hdmi.v:53
	vcdp->declBus(c+9,"MM2hdmi regMuxRed3",-1,7,0);
	// Tracing: MM2hdmi _T_23 // Ignored: Inlined leading underscore at MM2hdmi.v:55
	vcdp->declBus(c+10,"MM2hdmi regMuxRed4",-1,7,0);
	// Tracing: MM2hdmi _T_26 // Ignored: Inlined leading underscore at MM2hdmi.v:57
	vcdp->declBus(c+11,"MM2hdmi regMuxRed5",-1,7,0);
	// Tracing: MM2hdmi _T_29 // Ignored: Inlined leading underscore at MM2hdmi.v:59
	vcdp->declBus(c+12,"MM2hdmi regMuxRed6",-1,7,0);
	// Tracing: MM2hdmi _T_32 // Ignored: Inlined leading underscore at MM2hdmi.v:61
	vcdp->declBus(c+13,"MM2hdmi regMuxRed7",-1,7,0);
	// Tracing: MM2hdmi _T_35 // Ignored: Inlined leading underscore at MM2hdmi.v:63
	vcdp->declBus(c+14,"MM2hdmi regMuxRed8",-1,7,0);
	// Tracing: MM2hdmi _T_38 // Ignored: Inlined leading underscore at MM2hdmi.v:65
	vcdp->declBus(c+15,"MM2hdmi regMuxRed9",-1,7,0);
	// Tracing: MM2hdmi _T_41 // Ignored: Inlined leading underscore at MM2hdmi.v:67
	vcdp->declBus(c+16,"MM2hdmi regMuxRed10",-1,7,0);
	// Tracing: MM2hdmi _T_44 // Ignored: Inlined leading underscore at MM2hdmi.v:69
	vcdp->declBus(c+17,"MM2hdmi regMuxRed11",-1,7,0);
	// Tracing: MM2hdmi _T_47 // Ignored: Inlined leading underscore at MM2hdmi.v:71
	vcdp->declBus(c+18,"MM2hdmi regMuxRed12",-1,7,0);
	// Tracing: MM2hdmi _T_50 // Ignored: Inlined leading underscore at MM2hdmi.v:73
	vcdp->declBus(c+19,"MM2hdmi regMuxRed13",-1,7,0);
	// Tracing: MM2hdmi _T_53 // Ignored: Inlined leading underscore at MM2hdmi.v:75
	...
	// Tracing: MM2hdmi _T_77 // Ignored: Inlined leading underscore at MM2hdmi.v:96
	// Tracing: MM2hdmi _T_78 // Ignored: Inlined leading underscore at MM2hdmi.v:97
