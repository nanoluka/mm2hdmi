...
void VMM2hdmi::traceInitThis__1(VMM2hdmi__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	// Tracing: MM2hdmi _GEN_17 // Ignored: Inlined leading underscore at MM2hdmi.v:42
	// Tracing: MM2hdmi _T_5 // Ignored: Inlined leading underscore at MM2hdmi.v:43
	// Tracing: MM2hdmi _T_7 // Ignored: Inlined leading underscore at MM2hdmi.v:44
	vcdp->declBus(c+5,"MM2hdmi regData",-1,15,0);
	// Tracing: MM2hdmi _T_9 // Ignored: Inlined leading underscore at MM2hdmi.v:46
	vcdp->declBus(c+6,"MM2hdmi regMuxRed0",-1,7,0);
	// Tracing: MM2hdmi _T_12 // Ignored: Inlined leading underscore at MM2hdmi.v:48
	vcdp->declBus(c+7,"MM2hdmi regMuxRed1",-1,7,0);
	// Tracing: MM2hdmi _T_15 // Ignored: Inlined leading underscore at MM2hdmi.v:50
	vcdp->declBus(c+8,"MM2hdmi regMuxRed2",-1,7,0);
	// Tracing: MM2hdmi _T_18 // Ignored: Inlined leading underscore at MM2hdmi.v:52
	vcdp->declBus(c+9,"MM2hdmi regMuxRed3",-1,7,0);
	// Tracing: MM2hdmi _T_21 // Ignored: Inlined leading underscore at MM2hdmi.v:54
	vcdp->declBus(c+10,"MM2hdmi regMuxRed4",-1,7,0);
	// Tracing: MM2hdmi _T_24 // Ignored: Inlined leading underscore at MM2hdmi.v:56
	vcdp->declBus(c+11,"MM2hdmi regMuxRed5",-1,7,0);
	// Tracing: MM2hdmi _T_27 // Ignored: Inlined leading underscore at MM2hdmi.v:58
	vcdp->declBus(c+12,"MM2hdmi regMuxRed6",-1,7,0);
	// Tracing: MM2hdmi _T_30 // Ignored: Inlined leading underscore at MM2hdmi.v:60
	vcdp->declBus(c+13,"MM2hdmi regMuxRed7",-1,7,0);
	// Tracing: MM2hdmi _T_33 // Ignored: Inlined leading underscore at MM2hdmi.v:62
	vcdp->declBus(c+14,"MM2hdmi regMuxRed8",-1,7,0);
	// Tracing: MM2hdmi _T_36 // Ignored: Inlined leading underscore at MM2hdmi.v:64
	vcdp->declBus(c+15,"MM2hdmi regMuxRed9",-1,7,0);
	// Tracing: MM2hdmi _T_39 // Ignored: Inlined leading underscore at MM2hdmi.v:66
	vcdp->declBus(c+16,"MM2hdmi regMuxRed10",-1,7,0);
	// Tracing: MM2hdmi _T_42 // Ignored: Inlined leading underscore at MM2hdmi.v:68
	vcdp->declBus(c+17,"MM2hdmi regMuxRed11",-1,7,0);
	// Tracing: MM2hdmi _T_45 // Ignored: Inlined leading underscore at MM2hdmi.v:70
	vcdp->declBus(c+18,"MM2hdmi regMuxRed12",-1,7,0);
	// Tracing: MM2hdmi _T_48 // Ignored: Inlined leading underscore at MM2hdmi.v:72
	vcdp->declBus(c+19,"MM2hdmi regMuxRed13",-1,7,0);
	// Tracing: MM2hdmi _T_51 // Ignored: Inlined leading underscore at MM2hdmi.v:74
	vcdp->declBus(c+20,"MM2hdmi regMuxRed14",-1,7,0);
	// Tracing: MM2hdmi _T_54 // Ignored: Inlined leading underscore at MM2hdmi.v:76
	vcdp->declBus(c+21,"MM2hdmi regMuxRed15",-1,7,0);
	vcdp->declBus(c+22,"MM2hdmi outControlCounter",-1,3,0);
	// Tracing: MM2hdmi _T_56 // Ignored: Inlined leading underscore at MM2hdmi.v:79
	// Tracing: MM2hdmi _T_58 // Ignored: Inlined leading underscore at MM2hdmi.v:80
	// Tracing: MM2hdmi _T_60 // Ignored: Inlined leading underscore at MM2hdmi.v:81
	// Tracing: MM2hdmi _T_62 // Ignored: Inlined leading underscore at MM2hdmi.v:82
	// Tracing: MM2hdmi _T_63 // Ignored: Inlined leading underscore at MM2hdmi.v:83
	// Tracing: MM2hdmi _T_64 // Ignored: Inlined leading underscore at MM2hdmi.v:84
	// Tracing: MM2hdmi _T_65 // Ignored: Inlined leading underscore at MM2hdmi.v:85
	// Tracing: MM2hdmi _T_66 // Ignored: Inlined leading underscore at MM2hdmi.v:86
	// Tracing: MM2hdmi _T_67 // Ignored: Inlined leading underscore at MM2hdmi.v:87
	// Tracing: MM2hdmi _T_68 // Ignored: Inlined leading underscore at MM2hdmi.v:88
	// Tracing: MM2hdmi _T_69 // Ignored: Inlined leading underscore at MM2hdmi.v:89
	// Tracing: MM2hdmi _T_70 // Ignored: Inlined leading underscore at MM2hdmi.v:90
	// Tracing: MM2hdmi _T_71 // Ignored: Inlined leading underscore at MM2hdmi.v:91
	// Tracing: MM2hdmi _T_72 // Ignored: Inlined leading underscore at MM2hdmi.v:92
	// Tracing: MM2hdmi _T_73 // Ignored: Inlined leading underscore at MM2hdmi.v:93
	// Tracing: MM2hdmi _T_74 // Ignored: Inlined leading underscore at MM2hdmi.v:94
	// Tracing: MM2hdmi _T_75 // Ignored: Inlined leading underscore at MM2hdmi.v:95
	// Tracing: MM2hdmi _T_76 // Ignored: Inlined leading underscore at MM2hdmi.v:96
	// Tracing: MM2hdmi _GEN_2 // Ignored: Inlined leading underscore at MM2hdmi.v:97
	// Tracing: MM2hdmi _GEN_3 // Ignored: Inlined leading underscore at MM2hdmi.v:98
	// Tracing: MM2hdmi _GEN_4 // Ignored: Inlined leading underscore at MM2hdmi.v:99
	// Tracing: MM2hdmi _GEN_5 // Ignored: Inlined leading underscore at MM2hdmi.v:100
	// Tracing: MM2hdmi _GEN_6 // Ignored: Inlined leading underscore at MM2hdmi.v:101
	// Tracing: MM2hdmi _GEN_7 // Ignored: Inlined leading underscore at MM2hdmi.v:102
	// Tracing: MM2hdmi _GEN_8 // Ignored: Inlined leading underscore at MM2hdmi.v:103
	// Tracing: MM2hdmi _GEN_9 // Ignored: Inlined leading underscore at MM2hdmi.v:104
	// Tracing: MM2hdmi _GEN_10 // Ignored: Inlined leading underscore at MM2hdmi.v:105
	// Tracing: MM2hdmi _GEN_11 // Ignored: Inlined leading underscore at MM2hdmi.v:106
	// Tracing: MM2hdmi _GEN_12 // Ignored: Inlined leading underscore at MM2hdmi.v:107
	// Tracing: MM2hdmi _GEN_13 // Ignored: Inlined leading underscore at MM2hdmi.v:108
	// Tracing: MM2hdmi _GEN_14 // Ignored: Inlined leading underscore at MM2hdmi.v:109
	// Tracing: MM2hdmi _GEN_15 // Ignored: Inlined leading underscore at MM2hdmi.v:110
    }
}
