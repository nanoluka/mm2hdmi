...
VL_INLINE_OPT void VMM2hdmi::_sequent__TOP__1(VMM2hdmi__Syms* __restrict vlSymsp) {
	...
	if ((0x1fU == (IData)(vlTOPp->MM2hdmi__DOT__regRow))) {
	    vlTOPp->MM2hdmi__DOT__regVSync = vlTOPp->MM2hdmi__DOT___T_7;
	}
    }
    // ALWAYS at MM2hdmi.v:201
    ...
    vlTOPp->MM2hdmi__DOT___T_7 = (1U & ((IData)(1U) 
...
void VMM2hdmi::_ctor_var_reset() {
    ...
    MM2hdmi__DOT___T_7 = VL_RAND_RESET_I(1);
