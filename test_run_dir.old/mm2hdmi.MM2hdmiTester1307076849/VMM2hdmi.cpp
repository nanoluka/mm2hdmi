...
VL_INLINE_OPT void VMM2hdmi::_sequent__TOP__1(VMM2hdmi__Syms* __restrict vlSymsp) {
    ...
    VMM2hdmi* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at MM2hdmi.v:202
    vlTOPp->MM2hdmi__DOT__regNewData = vlTOPp->io_newData;
    // ALWAYS at MM2hdmi.v:202
    vlTOPp->MM2hdmi__DOT__regHSync = ((~ (IData)(vlTOPp->reset)) 
				      & (IData)(vlTOPp->MM2hdmi__DOT___T_1));
    // ALWAYS at MM2hdmi.v:202
    if (vlTOPp->reset) {
	vlTOPp->MM2hdmi__DOT__regVSync = 0U;
    } else {
	if (((0x1fU == (IData)(vlTOPp->MM2hdmi__DOT__regRow)) 
	     & (IData)(vlTOPp->io_newData))) {
	    vlTOPp->MM2hdmi__DOT__regVSync = vlTOPp->MM2hdmi__DOT___T_9;
	}
    }
    // ALWAYS at MM2hdmi.v:202
    ...
    vlTOPp->MM2hdmi__DOT__outControlCounter = ((IData)(vlTOPp->reset)
						    ...
						    ? 0U
						    : (IData)(vlTOPp->MM2hdmi__DOT___T_62)));
    vlTOPp->MM2hdmi__DOT___T_1 = (1U & ((IData)(1U) 
					+ (IData)(vlTOPp->MM2hdmi__DOT__regHSync)));
    vlTOPp->io_hSync = vlTOPp->MM2hdmi__DOT__regHSync;
    vlTOPp->MM2hdmi__DOT___T_9 = (1U & ((IData)(1U) 
	...
	if (vlTOPp->io_newData) {
	    vlTOPp->MM2hdmi__DOT__regRow = vlTOPp->MM2hdmi__DOT___T_4;
	}
    }
    // ALWAYS at MM2hdmi.v:202
    vlTOPp->MM2hdmi__DOT__regData = vlTOPp->io_data;
    vlTOPp->MM2hdmi__DOT___T_62 = (0xfU & ((IData)(1U) 
					   + (IData)(vlTOPp->MM2hdmi__DOT__outControlCounter)));
    vlTOPp->MM2hdmi__DOT___T_60 = ((0xfU == (IData)(vlTOPp->MM2hdmi__DOT__outControlCounter)) 
				   | (IData)(vlTOPp->MM2hdmi__DOT__regNewData));
    vlTOPp->MM2hdmi__DOT___GEN_15 = ((1U == (IData)(vlTOPp->MM2hdmi__DOT__outControlCounter))
    ...
    vlTOPp->io_red = ((0U == (IData)(vlTOPp->MM2hdmi__DOT__outControlCounter))
		       ...
		       : (IData)(vlTOPp->MM2hdmi__DOT___GEN_15));
    vlTOPp->io_blue = ((0U == (IData)(vlTOPp->MM2hdmi__DOT__outControlCounter))
		        ? (IData)(vlTOPp->MM2hdmi__DOT__regMuxRed0)
		        : (IData)(vlTOPp->MM2hdmi__DOT___GEN_15));
    vlTOPp->io_green = ((0U == (IData)(vlTOPp->MM2hdmi__DOT__outControlCounter))
			 ? (IData)(vlTOPp->MM2hdmi__DOT__regMuxRed0)
			 : (IData)(vlTOPp->MM2hdmi__DOT___GEN_15));
    vlTOPp->MM2hdmi__DOT___T_4 = (0x1fU & ((IData)(1U) 
...
void VMM2hdmi::_ctor_var_reset() {
    ...
    io_blue = VL_RAND_RESET_I(8);
    io_green = VL_RAND_RESET_I(8);
    io_vSync = VL_RAND_RESET_I(1);
    io_hSync = VL_RAND_RESET_I(1);
    MM2hdmi__DOT__regNewData = VL_RAND_RESET_I(1);
    MM2hdmi__DOT__regHSync = VL_RAND_RESET_I(1);
    MM2hdmi__DOT___T_1 = VL_RAND_RESET_I(1);
    MM2hdmi__DOT__regRow = VL_RAND_RESET_I(5);
    MM2hdmi__DOT___T_4 = VL_RAND_RESET_I(5);
    MM2hdmi__DOT__regVSync = VL_RAND_RESET_I(1);
    MM2hdmi__DOT___T_9 = VL_RAND_RESET_I(1);
    ...
    MM2hdmi__DOT___T_60 = VL_RAND_RESET_I(1);
    MM2hdmi__DOT___T_62 = VL_RAND_RESET_I(4);
    MM2hdmi__DOT___GEN_15 = VL_RAND_RESET_I(8);
