...
void VMM2hdmi::traceInitThis__1(VMM2hdmi__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	// Tracing: MM2hdmi _T_11 // Ignored: Inlined leading underscore at MM2hdmi.v:46
	vcdp->declBus(c+6,"MM2hdmi regMuxRed0",-1,7,0);
	// Tracing: MM2hdmi _T_14 // Ignored: Inlined leading underscore at MM2hdmi.v:48
	vcdp->declBus(c+7,"MM2hdmi regMuxRed1",-1,7,0);
	// Tracing: MM2hdmi _T_17 // Ignored: Inlined leading underscore at MM2hdmi.v:50
	vcdp->declBus(c+8,"MM2hdmi regMuxRed2",-1,7,0);
	// Tracing: MM2hdmi _T_20 // Ignored: Inlined leading underscore at MM2hdmi.v:52
	vcdp->declBus(c+9,"MM2hdmi regMuxRed3",-1,7,0);
	// Tracing: MM2hdmi _T_23 // Ignored: Inlined leading underscore at MM2hdmi.v:54
	vcdp->declBus(c+10,"MM2hdmi regMuxRed4",-1,7,0);
	// Tracing: MM2hdmi _T_26 // Ignored: Inlined leading underscore at MM2hdmi.v:56
	vcdp->declBus(c+11,"MM2hdmi regMuxRed5",-1,7,0);
	// Tracing: MM2hdmi _T_29 // Ignored: Inlined leading underscore at MM2hdmi.v:58
	vcdp->declBus(c+12,"MM2hdmi regMuxRed6",-1,7,0);
	// Tracing: MM2hdmi _T_32 // Ignored: Inlined leading underscore at MM2hdmi.v:60
	vcdp->declBus(c+13,"MM2hdmi regMuxRed7",-1,7,0);
	// Tracing: MM2hdmi _T_35 // Ignored: Inlined leading underscore at MM2hdmi.v:62
	vcdp->declBus(c+14,"MM2hdmi regMuxRed8",-1,7,0);
	// Tracing: MM2hdmi _T_38 // Ignored: Inlined leading underscore at MM2hdmi.v:64
	vcdp->declBus(c+15,"MM2hdmi regMuxRed9",-1,7,0);
	// Tracing: MM2hdmi _T_41 // Ignored: Inlined leading underscore at MM2hdmi.v:66
	vcdp->declBus(c+16,"MM2hdmi regMuxRed10",-1,7,0);
	// Tracing: MM2hdmi _T_44 // Ignored: Inlined leading underscore at MM2hdmi.v:68
	vcdp->declBus(c+17,"MM2hdmi regMuxRed11",-1,7,0);
	// Tracing: MM2hdmi _T_47 // Ignored: Inlined leading underscore at MM2hdmi.v:70
	vcdp->declBus(c+18,"MM2hdmi regMuxRed12",-1,7,0);
	// Tracing: MM2hdmi _T_50 // Ignored: Inlined leading underscore at MM2hdmi.v:72
	vcdp->declBus(c+19,"MM2hdmi regMuxRed13",-1,7,0);
	// Tracing: MM2hdmi _T_53 // Ignored: Inlined leading underscore at MM2hdmi.v:74
	vcdp->declBus(c+20,"MM2hdmi regMuxRed14",-1,7,0);
	// Tracing: MM2hdmi _T_56 // Ignored: Inlined leading underscore at MM2hdmi.v:76
	...
	// Tracing: MM2hdmi _T_77 // Ignored: Inlined leading underscore at MM2hdmi.v:95
	// Tracing: MM2hdmi _T_78 // Ignored: Inlined leading underscore at MM2hdmi.v:96
